 ...
 */
public class OfertasImpSalario extends OfertasImp {

    @Override
    public String ordena(String criterio) {
        //Ordenamos los objetos del array por el atributo salario y por el criterio indicado: ascendente o descendente
        // Para ordenar usamos el comparador.
        Collections.sort(Datos.getOfertas(), SalarioComp);
