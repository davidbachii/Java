...
//Tambien puede haber calses privadas
    

    
//Luego ya sean publicas o privadas pueden ser abstract o final    
//abstract class TiposDeClases_Bibliotecas
/*Una clase abstracta tiene al menos un método abstracto. Una clase abstracta no
se instancia, sino que se utiliza como clase base para la herencia. Ej: Codigo Figuras Geometricas*/
    
    
    
//final class TiposDeClases_Bibliotecas 
